...
namespace FMI::Comm {
    ...
    public:
        ...
        void isend(channel_data buf, FMI::Utils::peer_num dest) override;

        void irecv(channel_data buf, FMI::Utils::peer_num src) override;
        ...
        virtual void isend_object(channel_data buf, Utils::peer_num peer_id) = 0;

        virtual void irecv_object(channel_data buf, Utils::peer_num peer_id) = 0;
