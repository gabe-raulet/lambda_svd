...
namespace FMI::Comm {
    ...
    public:
        ...
        //! ISend data to peer with id dest, must match a recv call
        virtual void isend(channel_data buf, FMI::Utils::peer_num dest) = 0;

        //! IReceive data from peer with id src, must match a send call
        virtual void irecv(channel_data buf, FMI::Utils::peer_num src) = 0;
