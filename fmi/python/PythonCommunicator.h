...
namespace FMI::Utils {
    ...
    public:
        ...
        void isend(const boost::python::object& py_obj, FMI::Utils::peer_num dst, FMI::Utils::PythonData type);

        boost::python::object irecv(FMI::Utils::peer_num src, FMI::Utils::PythonData type);
